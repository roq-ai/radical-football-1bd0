...
function AcademyListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('academy', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/academies/view/${id}`);
    }
  };
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('academy', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/academies/create`} passHref legacyBehavior>
