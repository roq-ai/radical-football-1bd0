...
function TrainingPlanListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('training_plan', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/training-plans/view/${id}`);
    }
  };
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('training_plan', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/training-plans/create`} passHref legacyBehavior>
